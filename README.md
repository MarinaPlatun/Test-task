...
```
<br>Сервис-генератор 1 будет доступен по адресу: `http://localhost:8080`.
<br>Сервис-генератор 2 будет доступен по адресу: `http://localhost:8081`.
<br>Сервис-генератор будет доступен по адресу: `http://localhost:8082`.
